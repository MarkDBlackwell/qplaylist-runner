  ...
  module Segment
    module ModuleMethods
      ...
      def basename_playlist_in
        cartridge_number = cartridge_number_received
      ...
      def cartridge_number_received
        @@cartridge_number_received ||= ARGV[0]
      end
      ...
      def log_start_message
        "qplaylist-runner started #{cartridge_number_received}"
      end
      ...
      def sleep(song)
        time_song_start = time_start + song.second + song.minute * 60
